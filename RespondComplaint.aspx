<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RespondComplaint.aspx.cs" Inherits="RespondComplaint" %>
...
<body>
    ...
    <div align="center">
        <br><br>
        <h3><img src="Images/icon.png"/>&nbsp;&nbsp;Select Vendor</h3><br>

        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" 
            CellPadding="3" DataSourceID="SqlDataSource1" Width="784px">
            <Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT [ORDERNO], [TYPE], [WING], [FLATNO], [NAME], [DATE], [DESCRIPTION] FROM [COMPLAINT] WHERE ([FLATNO] = @FLATNO)">
            <SelectParameters>
                <asp:QueryStringParameter Name="FLATNO" QueryStringField="id" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>

        <br><br>
        <asp:DropDownList ID="DropDownList1" runat="server" Height="30px" Width="150px" DataTextField="TYPE" DataValueField="TYPE">
            <asp:ListItem Value="Processing"></asp:ListItem>
            <asp:ListItem Value="Pending"></asp:ListItem>
            <asp:ListItem Value="Resolved"></asp:ListItem>
        </asp:DropDownList>


        <asp:Button ID="Button1" runat="server"  Text="Update" Height="30px" 
            BackColor="#333300" CssClass="btn" ForeColor="White" onclick="Button1_Click" />
    ...
    <!--Footer -->
            <div align="center" style="margin-top:157px; background-color:#222222; color:White; height:50px; padding-top:15px;">
