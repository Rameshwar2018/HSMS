<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EnquiryAll.aspx.cs" Inherits="EnquiryAll" %>
...
<body>
    ...
    <!--enquiry form -->
            <br><br>
            <div align="center">
            <h3><img src="Images/icon.png"/>&nbsp;&nbsp;Society Visitors Information</h3><br>
            </div>
    
            <div align="center">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" 
                CellPadding="3" DataSourceID="SqlDataSource1" Width="966px">
                <Columns>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                ...
                SelectCommand="SELECT [NAME], [MEMBER], [ADDRESS], [CITY], [STATE], [PIN], [DATE], [INTIME], [OUTTIME] FROM [VISITOR_REG] WHERE ([SOCIETY] = @SOCIETY)">
                <SelectParameters>
    ...
    <!--Footer -->
            <div align="center" style="margin-top:122px; background-color:#222222; color:White; height:50px; padding-top:15px;">
