...
<head runat="server">
    ...
    <title>Delete Society Member</title>
...
<body>
    ...
    <div align="center">
        <br><br>
        <h3><img src="Images/icon.png"/>&nbsp;&nbsp;Delete Member Record</h3><br>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" 
            CellPadding="3" DataSourceID="SqlDataSource1" Height="105px" Width="824px">
            <Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT [FNAME], [SNAME], [WING], [FLATNO], [NOM], [MOB], [EMAIL], [STATUS] FROM [MEM_REG] WHERE (([SOCIETY] = @SOCIETY) AND ([USERNAME] = @USERNAME))">
            <SelectParameters>
    ...
    <br><br>
    <div align="center">
        <asp:Button ID="Button1" runat="server" Text="Confirm Delete" CssClass="btn" 
            BackColor="#996633" ForeColor="White" onclick="Button1_Click" />&nbsp;&nbsp;&nbsp;
        <asp:Button ID="Button2"    runat="server" Text="Cancel" CssClass="btn" 
            onclick="Button2_Click" BackColor="#996633" ForeColor="White" />
    </div>
