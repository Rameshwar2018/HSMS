<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MemApproval.aspx.cs" Inherits="MemApproval" %>
...
<body>
    ...
    <div><p style="color:#CC3300; text-align:right; margin-right:50px; margin-top:-100px;"><img src="Images/userlogo.png"/>&nbsp 
        Welcome <asp:Label ID="Label1" runat="server" Text=""></asp:Label></p></div>
    ...
    <br>
            ...
            <h3><img src="Images/icon.png"/>&nbsp;&nbsp;Member Approval Status</h3><br>
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    ...
                    CellPadding="3" DataSourceID="SqlDataSource1" Width="561px">
                    <Columns>
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="FNAME" 
                            DataNavigateUrlFormatString="MemDetails.aspx?id={0}" HeaderText="Status" 
                            Text="View" />
                    </Columns>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    SelectCommand="SELECT [FNAME], [SNAME], [WING], [FLATNO] FROM [MEM_REG] WHERE ([SOCIETY] = @SOCIETY)">
                    <SelectParameters>
    ...
    <!--Footer -->
            <div align="center" style="margin-top:139px; background-color:#222222; color:White; height:50px; padding-top:15px;">
