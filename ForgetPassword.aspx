...
<body>
    ...
    <div class="login-card" style="margin-top:145px;">
        ...
        <table style="width: 68%; margin-left:90px;" align="center">
            <tr>
                <td class="style4">
                    &nbsp;&nbsp;<asp:Label ID="Label2" runat="server" Text="Username :" Font-size="17px"   
                         ForeColor="Gray"></asp:Label>
                </td>
                <td class="style4">
                    &nbsp;&nbsp;<asp:TextBox ID="TextBox1" runat="server" Height="42px" Width="250px" required></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="style4">
                ...
                <td class="style4">
                     ...
                     &nbsp;&nbsp;<asp:TextBox ID="TxtDD" runat="server" Height="42px" 
                         Width="60px" placeholder="DD" MaxLength="2" required></asp:TextBox>
                     &nbsp;&nbsp;<asp:TextBox ID="TxtMM" runat="server" Height="42px" 
                         Width="60px" placeholder="MM" MaxLength="2" required></asp:TextBox>
                     &nbsp;&nbsp;<asp:TextBox ID="TxtYYYY" runat="server" Height="42px" 
                         Width="107px" placeholder="YYYY" MaxLength="4" required></asp:TextBox>
                </td>
            </tr>
         </table>
         <div style="margin-left:222px;">
                <asp:DropDownList ID="DropDownList1" runat="server" Height="42px" Width="250px">
            ...
            <br>
         <br/>
         <div align="center" style="margin-left:40px;"><asp:Button ID="Button1" 
