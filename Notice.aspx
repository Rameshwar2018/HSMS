...
<body>
    ...
    <div><p style="color:#CC3300; text-align:right; margin-right:50px; margin-top:-100px;"><img src="Images/userlogo.png"/>&nbsp Welcome <asp:Label ID="Label1" runat="server" Text=""></asp:Label></p></div>
    ...
    <div style="height:500px; margin-top:60px;" class="login-card" >
            <div align="center"><img src="Images/icon.png"/></div>
            <h1>Display Notices</h1><br>
        <table style="width: 53%; margin-left:180px; margin-top:-0px;;" >
            <tr>
                <td class="style4">
                    &nbsp;
                    <asp:TextBox ID="TextBox1" placeholder="Subject/Title" runat="server" Height="42px" Width="400px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="style4">
            ...
            <tr>
                <td class="style1">
                    &nbsp;
                    <asp:TextBox ID="TextBox3" placeholder="Description" runat="server" 
                        Height="72px" Width="400px" TextMode="MultiLine"></asp:TextBox>
                </td>
            </tr>
        </table> 
            ...
            <div align="center">
                <asp:Button ID="Button1" runat="server" BackColor="#4CAF50" CssClass="btn" 
                    ForeColor="White" Text="Add" onclick="Button1_Click" />
            </div>
