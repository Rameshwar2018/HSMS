<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VendorInfoMem.aspx.cs" Inherits="VendorInfoMem" %>
...
<body>
    ...
    <div id="admenu">
        <ul>
          ...
          <li><a href="#about">Accounting</a></li>
   ...
   <div align="center">
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" style=" box-shadow:0px 0px 8px 0px;"
                DataSourceID="SqlDataSource1" BackColor="White" BorderColor="#CCCCCC" 
            BorderStyle="None" BorderWidth="1px" CellPadding="3" Height="168px" 
            Width="908px">
            <Columns>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                ...
                SelectCommand="SELECT [FNAME], [LNAME], [TYPE], [MOB], [EMAIL], [ADDR], [CITY], [STATE], [PIN] FROM [VEN_REG] WHERE ([SOCIETY] = @SOCIETY)">
                <SelectParameters>
