    ...
    <div style="height:600px; margin-top:60px;" class="login-card" >
        ...
        <table style="width: 100%; margin-left:28px;" >
            <tr>
                <td class="style3">
                    &nbsp;
                    <asp:TextBox ID="TextBox1" placeholder="Order No." runat="server" Height="42px" Width="350px" required></asp:TextBox>
                </td>
                <td class="style5">
                    &nbsp;
                    <asp:TextBox ID="TextBox3" placeholder="Complaint Type" runat="server" Height="42px" Width="350px" required></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="style1" colspan="2">
                    &nbsp;
                    <asp:TextBox ID="TextBox2" placeholder="Description" runat="server" 
                        Height="62px" Width="737px" TextMode="MultiLine" required></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="style3">
                    ...
                    <asp:TextBox ID="TextBox13" placeholder="Wing Type" runat="server" Height="42px" 
                        Width="350px" ></asp:TextBox>
                </td>
                <td class="style5">
                    &nbsp;&nbsp;&nbsp;<asp:Label ID="Label4" runat="server" Text="Flat No. " Font-size="17px"   
                         ForeColor="Gray"></asp:Label>
                    <asp:TextBox ID="TextBox12" placeholder="Flat No." runat="server" Height="42px" Width="280px" ></asp:TextBox>
                </td>
            </tr>
            ...
            <tr>
                <td class="style2">
                    &nbsp;
                    <asp:TextBox ID="TextBox7" placeholder="Name" runat="server" Height="42px" Width="350px"></asp:TextBox>
                </td>
                <td class="style4">
                    &nbsp;&nbsp;
