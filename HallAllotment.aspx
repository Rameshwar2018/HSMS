<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HallAllotment.aspx.cs" Inherits="HallAllotment" %>
...
<body>
    ...
    <!--Admin Section -->
    <div align="center"><br>
        <br><h3><img src="Images/icon.png"/>&nbsp;&nbsp;Hall Allotment Status</h3><br>
            
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" 
                CellPadding="3" DataSourceID="SqlDataSource1" Width="682px">
            <Columns>
            ...
            SelectCommand="SELECT [RQNO], [NAME], [EVENT], [DATE], [STATUS] FROM [HALL_BOOKING] WHERE (([SOCIETY] = @SOCIETY) AND ([NAME] = @NAME))">
                <SelectParameters>
                    <asp:ControlParameter ControlID="Label2" Name="SOCIETY" PropertyName="Text" 
                        Type="String" />
                    <asp:QueryStringParameter Name="NAME" QueryStringField="id" Type="String" />
                </SelectParameters>
            </asp:SqlDataSource>

            <br><br>
        <asp:DropDownList ID="DropDownList1" runat="server" Height="30px" Width="150px">
                <asp:ListItem Value="Alloted"></asp:ListItem>
   ...
   <!--End of Admin Section -->
    ...
    <!--Footer -->
            <div align="center" style="margin-top:57px; background-color:#222222; color:White; height:50px; padding-top:15px;">
