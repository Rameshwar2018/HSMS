<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewAllMembers.aspx.cs" Inherits="ViewAllMembers" %>
...
<body>
    ...
    <div align="center">
        <br><br>
        <h3><img src="Images/icon.png"/>&nbsp;&nbsp;Society Member Information</h3><br>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" 
            CellPadding="3" DataSourceID="SqlDataSource1" Height="173px" Width="824px">
            <Columns>
                ...
                <asp:HyperLinkField DataNavigateUrlFields="USERNAME" 
                    DataNavigateUrlFormatString="DeleteMember.aspx?id={0}" 
                    HeaderText="REMOVE MEMBER" Text="Delete" />
            </Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT [FNAME], [SNAME], [WING], [FLATNO], [NOM], [MOB], [EMAIL], [USERNAME], [STATUS] FROM [MEM_REG] WHERE ([SOCIETY] = @SOCIETY)">
            <SelectParameters>
