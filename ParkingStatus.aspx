<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ParkingStatus.aspx.cs" Inherits="ParkingStatus" %>
    ...
    <div style="height:420px; margin-top:60px; padding-left:55px;" class="login-card" >
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            DataSourceID="SqlDataSource1" BackColor="White" BorderColor="#CCCCCC" 
                BorderStyle="None" BorderWidth="1px" CellPadding="3" Width="363px">
            <Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ConnectionString="<%$ ConnectionStrings:dbconnection %>" 
                ...
                SelectCommand="SELECT [FNAME], [SNAME], [PLNO] FROM [MEM_REG] WHERE (([FNAME] = @FNAME) AND ([SOCIETY] = @SOCIETY))">
            <SelectParameters>
        ...
        <div align="center">
            <br>      
            <asp:TextBox ID="TextBox1" runat="server" Width="300px" Height="35px" placeholder="Enter Parking Allocation No."></asp:TextBox>
            <br>       
            <asp:Button ID="Button1" runat="server" BackColor="#4CAF50" CssClass="btn" 
                ForeColor="White" onclick="Button1_Click" Text="Allocate" />       
        </div>
 </div>
