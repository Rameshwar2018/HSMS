<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HallBookingRequest.aspx.cs" Inherits="HallBookingRequest" %>
...
<body>
    ...
    <div align="center">
    <br>
    <br><h3><img src="Images/icon.png"/>&nbsp;&nbsp;Hall Booking Requests</h3><br>
            
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" 
                CellPadding="3" DataSourceID="SqlDataSource1" Height="129px" 
            Width="585px">
            <Columns>
                ...
                <asp:HyperLinkField DataNavigateUrlFields="NAME" 
                    DataNavigateUrlFormatString="HallAllotment.aspx?id={0}" 
                    HeaderText="ALLOTMENT STATUS" Text="Change" />
            </Columns>
            ...
            SelectCommand="SELECT [RQNO], [NAME], [EVENT], [DATE], [STATUS] FROM [HALL_BOOKING] WHERE ([SOCIETY] = @SOCIETY)">
                <SelectParameters>
