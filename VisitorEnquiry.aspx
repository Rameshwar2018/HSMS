<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VisitorEnquiry.aspx.cs" Inherits="VisitorEnquiry" %>
...
<body>
    ...
    <!--enquiry form -->
    <div style="height:320px; margin-top:60px; padding-left:55px;" class="login-card" >
        ...
        <table style="width: 100%; " >
            <tr>
                <td class="style4" align="center">
                    &nbsp;
                    <asp:TextBox ID="TextBox1" placeholder="Visitors Name" runat="server" Height="42px" Width="350px"></asp:TextBox>
                </td>
            </tr>
           ...
           <div align="center">    
                   <asp:Button ID="Button1" runat="server" Text="Show" BackColor="#4CAF50" 
                    CssClass="btn" ForeColor="White" onclick="Button1_Click"  />  
            </div>
