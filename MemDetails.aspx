<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MemDetails.aspx.cs" Inherits="MemDetails" %>
...
<body>
    ...
    <div style="margin-top:100px;">
            <h2 id="H1" class="ui--animation " style="text-align: center; Color:#CC0000;">Welcome To 
                <asp:Label ID="Label2" runat="server" Text=""></asp:Label></h2><div class="auto-format ui--animation"><p></p><center>To manage Cooperative Housing Society and Resident Welfare Association professionally.</center><p></p>
            <hr>
    </div>
    ...
    <div id="admenu" >
        <ul >
          ...
          <li><a href="#about">Hall Booking</a></li>
    ...
    <div align="center">
            <br>
            <h3><img src="Images/icon.png"/>&nbsp;&nbsp;Member Approval Status</h3><br>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                ...
                SelectCommand="SELECT [FNAME], [SNAME], [WING], [FLATNO], [NOM], [MOB], [EMAIL], [ADDR], [CITY], [STATE], [PIN], [DOB], [STATUS] FROM [MEM_REG] WHERE ([FNAME] = @FNAME)">
                <SelectParameters>
           ...
           <br><br><br>
            <asp:TextBox ID="TextBox1" runat="server" Placeholder="Allot Flat No." Height="30px" Width="150px" required></asp:TextBox><br><br>

            <asp:DropDownList ID="DropDownList1" runat="server" Height="30px" Width="150px">
                <asp:ListItem Value="Approved"></asp:ListItem>
                <asp:ListItem Value="Denied"></asp:ListItem>
            </asp:DropDownList><br><br>


            <asp:Button ID="Button1" runat="server"  Text="Update" Height="30px"
                onclick="Button1_Click" BackColor="#333300" CssClass="btn" 
                ForeColor="White" />
    </div>

    <!--Footer -->
            
            <div align="center" style="margin-top:170px; background-color:#222222; color:White; height:50px; padding-top:15px;">
