<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IssueWorkOrder.aspx.cs" Inherits="IssueWorkOrder" %>
...
<body>
   ...
   <!-- Menu Bar -->
    ...
    <div align="center">
        <br><br>
        <h3><img src="Images/icon.png"/>&nbsp;&nbsp;View Complaints</h3><br>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" 
            CellPadding="3" DataSourceID="SqlDataSource1" Height="57px" Width="958px">
            <Columns>
                ...
                <asp:HyperLinkField DataNavigateUrlFields="FLATNO" 
                    DataNavigateUrlFormatString="RespondComplaint.aspx?id={0}" HeaderText="RESPOND" 
                    Text="CLICK" />
            </Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT [ORDERNO], [TYPE], [WING], [FLATNO], [NAME], [DATE], [DESCRIPTION], [STATUS] FROM [COMPLAINT] WHERE ([SOCIETY] = @SOCIETY)">
            <SelectParameters>
